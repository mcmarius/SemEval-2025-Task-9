...
def make_food_prompt(example):
    ...
    prompt = f'Text: "{example}". Can you infer what specific food item is being described explicitly in this text? Respond only with <food item> or "missing".'
    return prompt
...
def make_hazard_prompt(example):
    ...
    prompt = f'Text: "{example}". Can you infer what specific food hazard is being described explicitly in this text? Respond only with <food hazard> or "missing".'
    return prompt
